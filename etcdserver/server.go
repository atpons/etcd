...
import (
	...
	"github.com/atpons/etcd/etcdserver/api"
	"github.com/atpons/etcd/etcdserver/api/membership"
	"github.com/atpons/etcd/etcdserver/api/rafthttp"
	"github.com/atpons/etcd/etcdserver/api/snap"
	"github.com/atpons/etcd/etcdserver/api/v2discovery"
	"github.com/atpons/etcd/etcdserver/api/v2http/httptypes"
	stats "github.com/atpons/etcd/etcdserver/api/v2stats"
	"github.com/atpons/etcd/etcdserver/api/v2store"
	"github.com/atpons/etcd/etcdserver/api/v3alarm"
	"github.com/atpons/etcd/etcdserver/api/v3compactor"
	pb "github.com/atpons/etcd/etcdserver/etcdserverpb"
	"github.com/atpons/etcd/lease"
	"github.com/atpons/etcd/lease/leasehttp"
	...
	"github.com/atpons/etcd/pkg/runtime"
	"github.com/atpons/etcd/pkg/schedule"
	"github.com/atpons/etcd/pkg/traceutil"
	"github.com/atpons/etcd/pkg/types"
	"github.com/atpons/etcd/pkg/wait"
...
var (
	plog = capnslog.NewPackageLogger("github.com/atpons/etcd", "etcdserver")
