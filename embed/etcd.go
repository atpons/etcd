...
import (
	...
	"github.com/atpons/etcd/etcdserver/api/v2v3"
	...
	runtimeutil "github.com/atpons/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("github.com/atpons/etcd", "embed")
